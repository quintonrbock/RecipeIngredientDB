...
public class RecipeDatabaseApplicationCopy {
    public static void main(String[] args) {
        System.out.println("\n\n\n\n");
        String url = "jdbc:oracle:thin:@127.0.0.1:1521/XE"; // Update if necessary
    ...
    public static void addIngredient() {
        ...
        try (Connection connection = DriverManager.getConnection(url, user, password);
            ...
            System.out.println("Attempting to add a blank ingredient...");
    ...
    private static int getNextIngredientId(Statement statement) throws SQLException {
    ...
    public static void deleteIngredient() {
        ...
        try (Connection connection = DriverManager.getConnection(url, user, password);
            ...
            System.out.println("Attempting to delete the last ingredient...");
